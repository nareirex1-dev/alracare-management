...
// ===== WHATSAPP FUNCTION =====
function contactViaWhatsApp(bookingId = null) {
    ...
    if (bookingId) {
        ...
        if (booking) {
            message = `Halo Alra Care, saya ${booking.patientInfo.name} dengan nomor booking ${bookingId}. Saya ingin konfirmasi booking untuk layanan ${booking.serviceInfo.serviceName} pada ${booking.appointmentInfo.date} jam ${booking.appointmentInfo.time}.`;
        }
    }
    ...
    const content = `
        <div class="confirmation-modal">
            ...
            <div class="confirmation-message">
                ...
                <!-- TAMBAHKAN INI: WhatsApp Contact -->
                <div class="whatsapp-contact">
                    <p>💬 <strong>Butuh Bantuan Cepat?</strong></p>
                    <p>Hubungi kami via WhatsApp:</p>
                    <div class="whatsapp-number">
                        <button class="whatsapp-btn large" onclick="contactViaWhatsApp('${bookingData.bookingId}')">
            ...
            <div class="confirmation-actions">
                ...
                <button class="cta-button whatsapp-btn" onclick="contactViaWhatsApp('${bookingData.bookingId}')">
            ...
            <html>
                <head>
                    ...
                    <style>
                        ...
                        .whatsapp-contact { background: #f0f9f0; padding: 15px; margin: 20px 0; border-radius: 8px; border-left: 4px solid #25D366; text-align: center; }
                        ...
                        .contact-number { text-align: center; margin: 10px 0; font-weight: bold; color: #25D366; }
                        @media print { 
                            body { margin: 20px; }
                ...
                <body>
                    ...
                    <div class="whatsapp-contact">
                        <h3 style="color: #25D366; margin-bottom: 10px;">Butuh Bantuan Cepat?</h3>
                        <p style="margin: 5px 0;">Hubungi kami via WhatsApp:</p>
                        <div class="contact-number">6281381223811</div>
                        <p style="margin: 5px 0; font-size: 12px;">Kami siap membantu Anda</p>
                    </div>
                    ...
                    <div class="footer">
                        ...
                        <p>Jl. Purnama No. 16, Pontianak • 6281381223811</p>
